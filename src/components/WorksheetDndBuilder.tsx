                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1.5">
                                    ...
                                    {question.type === 'vocab' && (
                                      <span className="text-[10px] font-medium px-1.5 py-0.2 rounded bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/40">
                                        Vocabulary
                                      </span>
                                    )}
                                    {question.type === 'dialogue' && (
                                      <span className="text-[10px] font-medium px-1.5 py-0.2 rounded bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800/40">
                                        Dialogue
                                      </span>
                                    )}
                                  </div>
